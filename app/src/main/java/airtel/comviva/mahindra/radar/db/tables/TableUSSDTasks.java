 ...
 */
public class TableUSSDTasks {
    public static final String TAG = "USSDTaskTable";

    public static final String TABLE_NAME = "ussdtasks";
    ...
    public static ArrayList<USSDTask> getAllTasks (SQLiteDatabase db) {
        Log.d(TAG, "getAllTasks: ");

        ArrayList<USSDTask> ussdTasks = new ArrayList<>();
